...
pub use aes::{
    ...
    noxtls_aes_xts_encrypt, AesCipher,
};
#[cfg(feature = "hazardous-legacy-crypto")]
pub use aes::{noxtls_aes_ecb_decrypt, noxtls_aes_ecb_encrypt};
pub use aria::{
    noxtls_aria_cbc_decrypt, noxtls_aria_cbc_encrypt, noxtls_aria_cfb_apply,
    noxtls_aria_cfb_decrypt, noxtls_aria_cfb_encrypt, noxtls_aria_ctr_apply,
    noxtls_aria_ctr_decrypt, noxtls_aria_ctr_encrypt, noxtls_aria_ofb_apply,
    noxtls_aria_ofb_decrypt, noxtls_aria_ofb_encrypt, AriaCipher,
};
#[cfg(feature = "hazardous-legacy-crypto")]
pub use aria::{noxtls_aria_ecb_decrypt, noxtls_aria_ecb_encrypt};
pub use camellia::{
    noxtls_camellia_cbc_decrypt, noxtls_camellia_cbc_encrypt, noxtls_camellia_cfb_apply,
    noxtls_camellia_cfb_decrypt, noxtls_camellia_cfb_encrypt, noxtls_camellia_ctr_apply,
    noxtls_camellia_ctr_decrypt, noxtls_camellia_ctr_encrypt, noxtls_camellia_ofb_apply,
    noxtls_camellia_ofb_decrypt, noxtls_camellia_ofb_encrypt, CamelliaCipher,
};
#[cfg(feature = "hazardous-legacy-crypto")]
...
pub use des::{
    ...
    noxtls_des_ofb_encrypt, DesCipher,
};
pub use poly1305::{
    noxtls_poly1305_key_gen, noxtls_poly1305_mac, noxtls_poly1305_mac_padded16,
    noxtls_poly1305_tags_equal,
};
#[cfg(feature = "hazardous-legacy-crypto")]
pub use rc4::Rc4;
