...
This section documents how **applications and firmware** interact with NoxTLS Rust for TLS 1.2 / 1.3 and DTLS. It complements **docs.rs** (symbol-level Rustdoc) with **device-relevant** grouping: what types matter, when to call them, and where to read deeper.
